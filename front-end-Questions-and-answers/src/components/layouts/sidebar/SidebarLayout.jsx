...
import MyLoadingMessage from "../../ui/MyLoadingMessage";
import Bg from "../Bg";
...
const navigation = [
  ...
  { name: "پاسخ ها", href: "/answers", icon: PencilSquareIcon, current: false },
];
            ...
            >
              <DialogPanel className="relative flex w-full max-w-xs flex-1 flex-col bg-gray-800 pt-5 pb-4">
                <TransitionChild
                  ...
                  leaveTo="opacity-0"
                >
                  <div className="absolute top-0 left-0 ml-2 pt-2">
                    <button
                      type="button"
                      ...
                      <NavLink
                        ...
                        className={({ isActive, isPending }) =>
                          isPending
                            ...
                            : "group flex items-center px-2 py-2 text-base font-medium rounded-md text-gray-300 hover:bg-gray-700 hover:text-white"
                        }
                      >
                        <item.icon
                          className="ml-4 flex-shrink-0 h-6 w-6 text-gray-400 group-hover:text-gray-300"
                          aria-hidden="true"
                        />
                        {item.name}
                      </NavLink>
